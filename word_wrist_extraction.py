...
parser.add_argument('--image_dir', type=str, default='./temp_input')
parser.add_argument('--output_dir', type=str, default='./temp_output')
                ...
                for pi in range(len(pose_scores)):
                    ...
                    for ki, (s, c) in enumerate(zip(keypoint_scores[pi, :], keypoint_coords[pi, :, :])):
                        if(posenet.PART_NAMES[ki] == 'rightWrist'):
                            ...
                            startX = int(c.tolist()[0])
                            endX = int(c.tolist()[0] + 300)
